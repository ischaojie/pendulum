...
class Date(FormattableMixin, date):
    ...
    def set(self, year=None, month=None, day=None) -> Date:
    ...
    def __sub__(self, other: Union[timedelta, date]) -> Union[Date, Period]:
    ...
    def diff(self, dt: Optional[date] = None, abs: bool = True) -> Period:
        """
    ...
    def next(self, day_of_week: Optional[int] = None) -> Date:
        """
    ...
    def previous(self, day_of_week: Optional[int] = None) -> Date:
        """
    ...
    def first_of(self, unit: str, day_of_week: Optional[int] = None) -> Date:
        """
    ...
    def last_of(self, unit: str, day_of_week: Optional[int] = None) -> Date:
        """
    ...
    def _last_of_month(self, day_of_week: Optional[int] = None) -> Date:
        """
    ...
    def _nth_of_month(self, nth: int, day_of_week: int) -> Union[Date, bool]:
        """
    ...
    def _first_of_quarter(self, day_of_week: int = None) -> Date:
        """
        Modify to the first occurrence of a given day of the week
    ...
    def _last_of_quarter(self, day_of_week: int = None) -> Date:
        """
        Modify to the last occurrence of a given day of the week
        in the current quarter. If no day_of_week is provided,
    ...
    def _nth_of_quarter(self, nth: int, day_of_week: int) -> Union[Date, bool]:
        """
        Modify to the given occurrence of a given day of the week
    ...
    def _first_of_year(self, day_of_week: int = None) -> Date:
        """
        Modify to the first occurrence of a given day of the week
    ...
    def _last_of_year(self, day_of_week: int = None) -> Date:
        """
        Modify to the last occurrence of a given day of the week
        in the current year. If no day_of_week is provided,
    ...
    def _nth_of_year(self, nth: int, day_of_week: int) -> Union[Date, bool]:
        """
        Modify to the given occurrence of a given day of the week
    ...
    def average(self, dt: Optional[date] = None) -> Date:
        """
